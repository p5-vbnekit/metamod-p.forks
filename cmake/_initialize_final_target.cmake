...
function("_initialize_final_target" "_target_name")
    ...
    if (MSVC)
        ...
        target_compile_options("${_target_name}" PRIVATE "-fpermissive")
    endif()

    message(WARNING "TODO: do not use -fpermissive for PE32+ x86_64")
    message(WARNING "TODO: fix -DOPT_TYPE=\"string\" for old mingw-w64 windres")
    message(WARNING "TODO: fix --add-stdcall-alias for old mingw-w64 compilers")
endfunction()
